...
export PEER0_ORG1_CA=${TEST_NETWORK_HOME}/organizations/peerOrganizations/central.example.com/tlsca/tlsca.central.example.com-cert.pem
export PEER0_ORG2_CA=${TEST_NETWORK_HOME}/organizations/peerOrganizations/regional.example.com/tlsca/tlsca.regional.example.com-cert.pem
export PEER0_ORG3_CA=${TEST_NETWORK_HOME}/organizations/peerOrganizations/gas.example.com/tlsca/tlsca.gas.example.com-cert.pem
...
setGlobals() {
  ...
  if [ $USING_ORG -eq 1 ]; then
    ...
    export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/central.example.com/peers/peer0.central.example.com/tls/ca.crt
    ...
    export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/regional.example.com/peers/peer0.regional.example.com/tls/ca.crt
    ...
    export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/gas.example.com/peers/peer0.gas.example.com/tls/ca.crt
...
verifyResult() {
  # وضع المتغيرات بين علامات تنصيص مزدوجة " " يمنع خطأ too many arguments
  if [ "$1" -ne 0 ]; then
    fatalln "$2"
  fi
}