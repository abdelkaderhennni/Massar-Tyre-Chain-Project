...
joinChannel() {
  ...
  echo "Joining peer0 of organization '$ORG_NAME' to the channel '$CHANNEL_NAME' ..."
...
infoln "Joining central peer to the channel..."
joinChannel 1
infoln "Joining regional peer to the channel..."
joinChannel 2
infoln "Joining gas peer to the channel..."
joinChannel 3

## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for central..."
setAnchorPeer 1
infoln "Setting anchor peer for regional..."
setAnchorPeer 2
infoln "Setting anchor peer for gas..."
setAnchorPeer 3
